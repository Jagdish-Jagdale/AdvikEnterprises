...
const FloatingContactButtons = () => {
  const phoneNumber = "8308375196";
  const whatsappUrl = `https://wa.me/91${phoneNumber}`;

  return (
    <div className="fixed bottom-22 right-8 z-[60]">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          className="relative z-10 w-12 h-12 bg-[#25D366] text-white flex items-center justify-center rounded-full shadow-[0_10px_25px_-5px_rgba(37,211,102,0.6)] hover:bg-[#128C7E] transition-all duration-300 ring-2 ring-white"
